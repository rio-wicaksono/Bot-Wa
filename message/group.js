...
import { getBuffer, getRandomFile, getGroupAdmins,sleep} from "../lib/myfunc.js"
...
let url = `https://youtu.be/MVgeiiomiWE?si=g3mSYKVN9DV7TCA9`
const contextInfo = { 
mentionedJid: [sender],
externalAdReply:{
...
let yui = fs.readFileSync('./temp/audio/dj 2.mp3')
